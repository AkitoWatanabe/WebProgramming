...
<html lang="ja">
	...
	<body>
		...
		<form action="SignupServlet" method="post">
			<div class="Container">
				<div id="tittle1">ログインID</div><div id="text1"><input type="text" name="loginId" required></div>
				...
				<div id="tittle4">ユーザ名</div><div id="text4"><input type="text" name="userName" required></div>
				<div id="tittle5">生年月日</div><div id="text5"><input type="text" name="birthday" required></div>
