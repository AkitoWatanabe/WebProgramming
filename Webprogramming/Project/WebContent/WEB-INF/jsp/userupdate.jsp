...
<html lang="ja">
	...
	<body>
		...
		<form action="UserUpdateServlet" method="post">
			<div class="Container">
				<div id="tittle1">ログインID</div><div id="text1"><input type="hidden" name="loginId" value =${userData.loginId}>${userData.loginId}</div>
				...
				<div id="tittle4">ユーザ名</div><div id="text4"><input type="text" name="name" required value=<c:if test="${userData.name != null}" >${userData.name}</c:if>></div>
